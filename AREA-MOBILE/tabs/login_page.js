...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const apiUrl = `${env.API_URL}/users/login`;
  ...
  const handleGoogleLogin = async () => {
    // Implémenter la logique de connexion avec Google ici
    // Utilisez le SDK Google Sign-In pour gérer l'authentification avec Google.
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        <View style={styles.content}>
          ...
          <TouchableOpacity style={styles.BrandsButton} onPress={handleGoogleLogin}>
          ...
          <TouchableOpacity style={styles.BrandsButton} onPress={handleFacebookLogin}>
          ...
          <TouchableOpacity style={styles.BrandsButton} onPress={handleAppleLogin}>
          ...
          <View style={styles.containerTextAccount}>
            <Text style={styles.AccountYet}>You do not have an AREA account ?</Text>
            <TouchableOpacity onPress={navigateSignUp}>
              <Text style={styles.SignUpYet}>Sign up</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
